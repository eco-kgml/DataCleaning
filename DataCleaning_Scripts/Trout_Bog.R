...
res <- read_data_entity_names(packageId = "knb-lter-ntl.69.23")
raw <- read_data_entity(packageId = "knb-lter-ntl.69.23.r", entityId = res$entityId[3])
...
res <- read_data_entity_names(packageId = "knb-lter-ntl.70.28")
raw <- read_data_entity(packageId = "knb-lter-ntl.70.28.r", entityId = res$entityId[3])
data <- readr::read_csv(file = raw)
